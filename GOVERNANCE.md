...
> ```
>
> **Current state, measured 2026-09-03.** Finding 221's 38 errors are fixed and
...
~~Command-line usage is documented in full in `docs-notes/CLI-REFERENCE.md`.~~ **The governance command line was removed on 2026-09-07.** Its full specification is kept, with the reasons and a restore procedure, in `old-docs/removed-cli-surface/`.
...
alone will be **two hundred and eleven findings short**, 135 through 345,
...
and ninety-one" at 325 and "two hundred and two" at 336 and "two hundred and four" at 338 and "two hundred and seven" at 341; the number is
