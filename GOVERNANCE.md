...
> on 2026-09-07. The index of every finding, 1 to 371, is at the end of the
...
> (2026-08-30): `bootstrap-root` answers 409 once it exists, so the isolation
> between organisations is real, tested, and exercised by nothing that ships
> (`mg/HANDOFF.md` §7, caveat 11; T49).
>
...
**What deletion does not clear, recorded 2026-09-14.** The account's governance
conversation with the agent stays, and comes back to that account if the name is
registered again. And on the host, deleting from the dashboard removes only the
agent's entry from OpenClaw's configuration, where OpenClaw's own delete also
removes its scheduled jobs, host exec approvals and session store entries, and
by default its workspace and session files. Whether a new agent provisioned under
the name inherits those is not yet proven, and whether governance should delete
them is a decision for Kinan (`mg/REMAINING-WORK.md` §"The QA over three days").
...
alone will be **two hundred and thirty-seven findings short**, 135 through 371,
...
and ninety-one" at 325 and "two hundred and two" at 336 and "two hundred and four" at 338 and "two hundred and seven" at 341 and "two hundred and eleven" at 345 and "two hundred and thirty-four" at 368; the number is
