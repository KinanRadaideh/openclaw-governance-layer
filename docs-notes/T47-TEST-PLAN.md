...
Each row is a defect found and fixed in that pass (findings 346–362). The row fails
if the defect is back. Row 3.2.12 and row 6b.5 could not have passed before it.

| #        | Who                                                     | Do this                                                                                                              | Expect                                                                                                                                                                                                                                                                                                                                        |
| -------- | ------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **6c.1** | Anyone with an agent, with the Control UI open in a tab | From _Your agents_, ask the agent to do something no rule covers, with escalation on                                 | An approval card appears in the Control UI within seconds. **No card, followed by a row in _Awaiting your decision_ saying it timed out, is finding 347 back**                                                                                                                                                                                |
| **6c.2** | Same                                                    | Ask again, and leave the card unanswered until it expires                                                            | After about two minutes the row in _Awaiting your decision_ says **timed out**. **The cancelled case cannot be driven by hand**: the card covers the page, so the conversation's Cancel cannot be pressed while it is up (a press there answers the card). It is proved by the API probe and the tests; see finding 348 in the sweep register |
