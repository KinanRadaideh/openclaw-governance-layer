...
date.** The right-hand column is only what the documents said on 2026-09-13.

| Number                        | Re-derive with                                                                                                      | Recorded 2026-09-13                                                        |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| Findings found / fixed / open | The Findings cell of `mg/HANDOFF.md` §1's state table, checked against the registers                                | 364 / 363 / 1 (169 open; 363 and 364 fixed later that day)                 |
| Backlog items open            | Count the unstruck rows of `mg/HANDOFF.md` §6's open table                                                          | Thirteen unstruck including T1, so twelve open                             |
| Governance test counts        | `node node_modules/vitest/vitest.mjs run src/governance/ src/gateway/governance-*.test.ts ui/src/pages/governance/` | 2,928 passed / 21 skipped / 155 files (2026-09-13)                         |
| Linux test counts             | The same suite, run on Ubuntu                                                                                       | **Last measured before T44 — do not quote as current**                     |
| Typechecks and lint           | `mg/HANDOFF.md` §4                                                                                                  | Typechecks clean; the full lint gate not re-proven end to end (HANDOFF §4) |
