...
| Figures                     | `docs-notes/FIGURES.md`                                                                                                                         | F1–F24, each in prose, Mermaid and TikZ, with keep/cut advice (T17); re-audited and the Mermaid parsed 2026-09-19; all fourteen kept figures compiled and visually checked 2026-09-20, not yet inside `main.tex` |
