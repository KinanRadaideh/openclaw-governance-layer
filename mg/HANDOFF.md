...
>   requirements fully met. **2,684 tests across 144 file runs, green on Windows**
>   (2026-09-02), six verification commands, all green. **No security gap known _as of the
>   ninth sweep_ — and read that qualifier**, because the same sentence was true
>   and wrong on each of the four previous days, the seventh sweep included.
> - **The engineering on the backlog is finished, and that is not the same as
>   "no bugs left".** Nine sweeps across 2026-09-01/02 found **fifty-three
>   defects between them (172–224), seventeen security-relevant. All fifty-three
>   are closed.** They include a cross-tenant hole an earlier round had already
>   fixed on one surface only, a file-mode defect that would have failed the
>   deployment report on the first VPS boot, and **finding 202: an emergency stop
>   that reported success and stopped nothing.**
...
### 2026-09-02 (latest) — a sweep on a new axis, and a test that could not fail
...
| Command                  | Expected                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Governance suite         | **2,684 across 144 file runs (2,679 passed + 5 skipped) — measured 2026-09-02 on Windows**, after T44 and the fourth through eighth segment sweeps. **Measured in two shards and added**, because a single combined run takes tens of minutes on Windows and its reporter prints nothing until it finishes when stdout is redirected, which is indistinguishable from a wedged process. **Write the arithmetic down, not the total** (finding 220's rule, and this figure nearly broke it on the day it was written): `src/governance/` gives **91 file runs — 90 passed + 1 skipped — and 1,229 tests, 1,224 passed + 5 skipped**; `src/gateway/governance-*.test.ts ui/src/pages/governance/` gives **53 file runs and 1,455 tests, all passed**. So **91 + 53 = 144 file runs** and **1,229 + 1,455 = 2,684 test executions, of which 2,679 passed**. These are runs and executions, not distinct files and tests — the fifteen gateway files each run in three projects (finding 109). Do not run two vitest processes at once; they contend badly enough to look stalled. The **+6 file runs and +31 executions** over 2,653/138 are six new regression files (findings 209/210, 211, 213, 215, 216 and 222) plus two cases added to `codex-backend.test.ts` for finding 217. **The gateway/UI shard crashed a worker on the first attempt of this measurement** — "Worker exited unexpectedly", reported as nine failed tests that were nothing of the kind — and passed cleanly on the re-run. That is the third infrastructure failure this project has seen reported as test failures (findings 169 and the 2026-08-30 pair); **re-run before believing a failure you cannot explain.** **The last Ubuntu 24.04 measurement is the one before those: 2,548 across 133**, which was the first time this suite had been green on the deployment platform — re-run it there before quoting a Linux figure. On Windows 5 are skipped: `state-file-permissions.test.ts` asserts POSIX modes and says so rather than pretending to run everywhere. **Run it alone** — two runs on 2026-08-30 reported failures that did not exist because a mutation shared the tree, and one run on 2026-08-31 reported a single failure three later runs did not reproduce and that was never identified, because the output was piped through a filter that discarded the name (finding 169). **Before 2026-09-01 it was not green on Linux at all** — 2 failures, both tests asserting Windows separator behaviour unconditionally (findings 184, 185) — while five documents said "the full suite runs on Ubuntu under WSL2" |
| `tsgo:core`              | clean                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `tsgo:ui`                | clean                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
