...
>   is **T47's plan**: `docs-notes/T47-TEST-PLAN.md`, 138 checks across
...
**Re-derived 2026-09-04 by counting the table rather than incrementing: 54
items, 42 struck (done or cancelled), T1 deprioritised and not being done, and
**11 open**.** _(This block read "43 tasks… 36 done, 5 open" until 2026-09-04,
and before that "38 done", which summed to 45 against a list of 43. **Count the
rows; do not adjust the number.** `grep -cE '^\| ~~\*\*T[0-9]+\*\*~~' `on
...
| **T47** | All three        | **The by-hand test plan is written** (`docs-notes/T47-TEST-PLAN.md`, 138 checks). Running it needs three people on three machines |
