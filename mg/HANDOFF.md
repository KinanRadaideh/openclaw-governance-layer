...
>   requirements fully met. **2,756 passed and 20 skipped across 153 file runs,
>   green on Windows** (re-measured 2026-09-06), **seven**
...
>   on three separate days**, across 2026-09-01/06, found **ninety-seven defects
>   between them, 172 through 268 inclusive (268 − 172 + 1 = 97). Ninety-five are
...
### 2026-09-06 (latest): an operator's second sitting, and T53 closed
...
| Backlog          | **56 items, 42 struck, T1 not being done, 13 open.** Re-derived from the rows 2026-09-05, finding 259: this cell read "54 items, 42 struck … 11 open" and was wrong in both directions before T55 existed                                                                                                           |
| Defects          | **268 found, 265 fixed**, 157 withdrawn, and **two open**: 169 as an unexplained observation, 258 as a decision (T55). 260's aiming half is fixed and its visibility half is T56                                                                                                                                    |
...
**Re-derived 2026-09-05 by counting the table rather than incrementing: 56
items, 42 struck (done or cancelled), 14 open, of which T1 is deprioritised and
not being done, so 13 are actually outstanding.** _(This block read "54 items,
...
| ------------------------------------------------------- | ------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `REMAINING-WORK.md` §"The numbered backlog", **T1–T56** | The original project, plus everything added since             | **42 struck, 14 open** (42 + 14 = 56). T1 is open but not being done; T41 was cancelled and is struck. Re-derived from the rows 2026-09-05, finding 259: this cell read "T1–T53 … 39 done, 12 open" while §1 read "54 items, 42 struck … 11 open", and neither matched the table |
