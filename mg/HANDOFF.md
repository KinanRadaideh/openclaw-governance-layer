...
>   requirements fully met. **2,695 tests across 145 file runs, green on Windows**
>   (2026-09-03), six verification commands, all green. **No security gap known _as of the
>   eleventh sweep_ — and read that qualifier**, because the same sentence was true
...
>   "no bugs left".** Eleven sweeps plus the VPS deployment, across 2026-09-01/03,
>   found **sixty-one defects between them (172–232), nineteen security-relevant.
>   All sixty-one are closed.** The last three came from a **clean server** rather
...
| -------------------------------------------------------- | ------------------------------------------------------------- | ---------------------------------------------------------------- |
| `REMAINING-WORK.md` §"The numbered backlog" — **T1–T48** | The original project, plus everything added since             | **37 done, 9 open**; T1 and T41 not being done (37 + 9 + 2 = 48) |
...
**Five were open before 2026-09-03 and four were added that day.** T3 is now
half done — the fork is installed and running on a VPS; what remains of it is the
demonstration, not the deploy.
...
| **T45** | Claude           | **A first-run installation guide for a newcomer.** `LINUX-INSTALL.md` is a deployment runbook that opens with why the normal install does not work; somebody meeting this project needs the step before that. Should absorb §2c's cold-server findings as instructions                                                                                                                                                                                                  |
