...
>   "no bugs left".** Eleven sweeps across 2026-09-01/03 found **fifty-eight
>   defects between them (172–229), nineteen security-relevant. All fifty-eight
...
### 2026-09-03 (latest) — the half of the code that only runs on a bad day
