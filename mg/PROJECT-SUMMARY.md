...
| `docs-notes/T47-TEST-PLAN.md`          | The by-hand test plan, one list per tier plus rows needing several people; §6b, §6c and §6d added for T60/T63, the dashboard QA pass and the work after the push; 198 rows, checked against the code 2026-09-14                                                                                                          |
