...
15. A Root-only **deployment and network report** that reads the live
...
| `src/cli/program/register.governance.ts`            | The `openclaw governance ...` command tree. The agent-registry commands live beside it in `register.governance.agents.ts`, and the identity gate both use in `governance-cli-gate.ts` (M4)                                                                                                                                                                                                                                                                                                                                                                                                              |
...
- **2,108 governance tests pass across 99 files** — file _runs_, not files; 1,300 distinct tests across 73 distinct files, because the thirteen gateway files each run under three Vitest projects (measured 2026-08-24, after M4, the agent registry); `pnpm tsgo:core` and `pnpm tsgo:ui` both clean;
