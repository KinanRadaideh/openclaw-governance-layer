...
> **Newest, 2026-09-19 (later).** The dashboard was driven live with a mock model connected, which
...
| `docs-notes/T47-TEST-PLAN.md`          | The by-hand test plan, one list per tier plus rows needing several people; §6b, §6c and §6d added for T60/T63, the dashboard QA pass and the work after the push; 208 rows, checked against the code 2026-09-14, four C13 rows added 2026-09-15, three on 2026-09-18 and three (§6e, findings 377–379) on 2026-09-19; the rows the live checks of 2026-09-18 and 19 pressed, and those still never pressed, are listed at its top and flagged in their sections |
