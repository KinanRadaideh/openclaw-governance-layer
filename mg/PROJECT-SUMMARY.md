...
- **Branch:** `governance-layer`, **NOT clean as of 2026-08-27**, **45** commits ahead
  ...
  "clean as of 2026-08-24, 22 commits ahead" until it was measured). **111 files
  are uncommitted** (`git status --porcelain | wc -l`): T7's audit half, T29,
  T30, finding 120's fix and the whole of M5 and M6, **nine of them untracked**. Pushed to a
  private remote on 2026-08-21 — **nothing since has been
  pushed**, so **30 commits** are unpushed and the remote sits at the 2026-08-21
  tip, with the newest work in no commit at all. `origin` points at upstream OpenClaw, so this branch
