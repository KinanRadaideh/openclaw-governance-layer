...
**Current as of 2026-09-11.** A single place to understand what this
...
> **Three things to know before anything else (2026-09-11).** **The project is
> moving into its documentation phase**, and `docs-notes/WRITING-GUIDE.md` is where
> writing starts. **T60 and T63 were built on 2026-09-11 and were uncommitted when
> this was written** — check `git status` before assuming a clean tree. And the
...
| ~~`src/cli/program/register.governance.ts`~~                                        | ~~The `openclaw governance ...` command tree~~ **Removed 2026-09-07.** The whole surface — six files, `governance-cli-gate.ts` and `src/governance/cli-identity.ts` — is archived with its tests and a restore procedure in `docs-notes/removed-cli-surface/`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `docs-notes/removed-cli-surface/`      | The command-line surface removed 2026-09-07: every source file and test, why it went, what was lost, and a restore procedure. `CLI-REFERENCE.md` moved in with it                                                                                                                                                        |
...
| `docs-notes/T2-LIVE-RUN.md`            | The runbook for the live demonstration. **T2 was done on 2026-09-06**; the runbook is kept because the run is worth repeating — finding 273 was fixed after it, so the intent field in the existing evidence belongs to the wrong turn                                                                                   |
| `docs-notes/T47-TEST-PLAN.md`          | The by-hand test plan, one list per tier plus rows needing several people; rows 6b.1–6b.5 added for T60 and T63                                                                                                                                                                                                          |
...
| `mg/REMAINING-WORK.md`                 | The long-form backlog, T1–T64, and the M-series. Count `mg/HANDOFF.md` §6's rows for what is open                                                                                                                                                                                                                        |
| `mg/SESSION-LOG-2026-08.md`            | What the August 2026 session changed, and why                                                                                                                                                                                                                                                                            |
| `mg/SESSION-LOG-2026-09.md`            | What September 2026 changed, and why, through 2026-09-11                                                                                                                                                                                                                                                                 |
| `mg/REMAINING-WORK-DASHBOARD-SWEEP.md` | What is left, sorted by who has to move first; the full records of T60, T63 and T64                                                                                                                                                                                                                                      |
...
>
> **The state in one line, as of 2026-09-13:** built, verified and
> **demonstrated** (T2, on the VPS, 2026-09-06); the dashboard driven section by
> section from all four tiers, and then through a browser under failure; **363 findings, 361 fixed, two open** (169, an unexplained observation; 363, a decision); **T60 and T63
> built on 2026-09-11**, with eighteen defects found around them and seventeen fixed on
> 2026-09-12 and 13; and what remains is
> a Linux re-measurement (T3), the by-hand plan (T47), the figures (T17), the report
> (T18), a read (T13), and judgements on T46, T48, T49 and T58/T59. **The
