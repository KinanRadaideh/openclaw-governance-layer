...
| **B5**     | **T47 — run the by-hand test plan.** Written (`docs-notes/T47-TEST-PLAN.md`, 208 checks as of 2026-09-19; most rows needing a model were pressed live that day with a mock one, and the rest are listed at its top). **Running it needs three people on three machines**: half of what it tests is that one account cannot see another's, and a shared browser session silently defeats that                                                                                                                                                                                                                                                     | This produces the evidence Chapter 4 needs. **This sweep is not a substitute** — it drove one browser and one server                                                                                               |
