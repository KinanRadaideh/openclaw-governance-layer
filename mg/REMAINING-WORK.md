...
`CHAPTER3-MATERIAL.md` measures that diff, **310 files, 122,699 insertions, 349
deletions as of 2026-09-05**, split there into 44 prose files and 266 code ones. Deleting upstream's CI would falsify that
...
## Where this file's findings stop, and where 241–261 are (recorded 2026-09-05)

**This file's finding write-ups end at 240.** Findings **241–261** are not in it,
