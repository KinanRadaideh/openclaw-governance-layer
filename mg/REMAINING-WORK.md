...
is in `docs-notes/QA-IN-PLAIN-TERMS.md` §3; the independent review's own analysis (its §7) was removed with it on 2026-09-13 and is in git history.

---

## The numbered backlog

**This is the long-form outstanding list; its counts are checked against `mg/HANDOFF.md` §6.** It supersedes §"What is actually
...
> line above, 37 done, 9 open, 2 not being done, over 48 rows**, and the way to
> confirm it is to count the rows of the table itself, which is what that line
> was derived from (verified 2026-09-03: 48 rows, T1–T48, no gaps; T45–T48 were
> added that day from the VPS deployment and are all open).
>
...
**Current as of 2026-09-14: 55 struck, 11 open, across 66 tasks** (T1–T64, T68 and
T69; T65–T67 live in the sweep register). 55 + 11 = 66, and the arithmetic is written out because without it this line was wrong
again within the hour. _(Moved from 48/14 across T1–T62: **T63 and T64 were
added** on 2026-09-08, and **T50, T55, T64, T60 and T63 closed** between
2026-09-08 and 2026-09-11. Re-derived from `mg/HANDOFF.md` §6's open table,
which holds eleven unstruck rows including T1, rather than by adjusting this
line.)_ T1 is open but not being done; T41 was cancelled and is
struck. **If you re-derive this with a grep it will disagree**, because
T13 carries a struck row reading _DRAFTED_, for the drafting sub-task, while T13
itself — reading the answer until you can give it without notes — is open.
_(Moved from 47/15 on 2026-09-08: **T61 closed** as finding 297, the wrong-password
banner, fixed at the API layer as its own row recommended. Re-derived by counting
the rows, not by decrementing.)_

_(This line read "Current as of 2026-09-03: 37 done, 9 open … across T1–T48"
for four days and twelve task-state changes, while the table at the top of this
file was re-derived twice. Finding 282's class, in the file that holds the
backlog.)_
...
figures, the report. Nothing is waiting on Claude.~~ **Not true since
2026-09-05, and it is the third time this sentence has been written prematurely.**
Six of the fifteen open items are _Kinan then Claude_ — T46, T50, T51, T58, T59
and T60 — each needing a decision first and then work; T47 needs all three
people; and the live run and the Linux install are both done. **What is waiting
on Kinan alone is smaller than it used to be, and what is waiting on Claude is
no longer nothing.** See the table below rather than this paragraph, which the
section heading directly above already warns is the one that keeps going stale.
...
**The count of findings is now 232**, and the shape of the last sixty-one is
...
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ~~**T2**~~  | ~~Run it once with a real model driving a real tool call.~~ **DONE 2026-09-06, on the VPS.** Kimi (`kimi-for-coding`), driving agent `jack`, was asked to read `~/.npmrc` and attempted it; the gate refused it and wrote ledger entry **#25**, `read /root/.npmrc`, decision **deny**, naming the rule that did it: `core-path-credential-files-env-private-keys-npmrc-netrc-re`. The chain verified intact at 25 entries with the checkpoint agreeing. **The first attempt failed for an instructive reason and is worth keeping**: asked for `~/.ssh/id_rsa`, the model refused on its own before making any tool call, so nothing reached the gate and nothing was recorded — the ledger's silence was correct. A request that _sounds_ like a secret tests the model's safety training; a boring-sounding file that is actually a credential tests the gate. That distinction belongs in Chapter 4                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| **T47**     | **All three. A by-hand test plan, one list per RBAC tier, split between K, M and O.** **THE PLAN IS WRITTEN (2026-09-04): `docs-notes/T47-TEST-PLAN.md`.** **138 checks as first written, plus **four added 2026-09-05** from findings 256 and 260,** (counted 2026-09-04, not estimated) across four tiers plus a section of things no one person can test alone, each with what to do, what to expect, and a column for what actually happened. **Running it is what remains, and it needs three people and three machines** — half of what it tests is that one account cannot see or do another's, and a shared browser session silently defeats that. Everything verified so far is automated or was driven by whoever wrote it; what has never happened is three people exercising the four tiers from the operator's chair. The two questions every row asks are **was the outcome visible** and **did the refusal say what to do instead**, because an action that produces nothing with nothing explaining why is this project's worst bug class. §5 is the part worth the coordination: an Administrator stopping a User's agent mid-prompt, a password changed under a live session, authoring withheld while a rule is half-typed. Produces the operator-visible evidence Chapter 4 needs and is the natural companion to T2 **Thirteen rows added 2026-09-07**, the night T2 landed: Root owning an agent and the two lists that must stay separate, an agent knowing the name it was given, the Talk panel and the empty reply, signing out in a shared tab, and the escalation's new "Allow always" and the proposal it files. **Results now go in the shared sheet rather than into the file**, and §0 gains the rule that cost the first T2 attempt: ask for a boring credential file, not a scary one, or the model refuses before the gate is consulted                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ~~**T48**~~ | **DECIDED BY KINAN 2026-09-15: yes, write Chapter 3 now**, flagging in it anything T3 or T47 changes afterwards. _Original row:_ **Kinan. Decide whether Chapter 3 is ready to be written.** `CHAPTER3-MATERIAL.md` is ~9,300 lines of design material accumulated across 76 sections. The question is not whether there is enough; it is whether the design has stopped moving. Findings 230–232 argue it has not quite, three defects in the deployment path in one evening, so the honest answer may be "after the VPS trip closes". A judgement, not a task                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ~~**T49**~~ | **DECIDED BY KINAN 2026-09-15: option (b).** One organisation per installation is the boundary, and the organisation structure stays; the reasoning, including why the code is not removed, is `docs-notes/CHAPTER3-MATERIAL.md` §3.5.89. _Original row:_ **Kinan. Decide what the multi-tenancy machinery is for now.** M5 built per-group storage, `requireGroup`, `requireManagedAgent` and the roster filters; the 2026-08-30 cap means **a shipped installation only ever has one organisation**, so none of it is exercised by anything that ships. Findings 234 and 235 were both **latent for exactly that reason**. The isolation was absent and nothing could notice. Two honest positions: keep the machinery and say in the report that it is verified by test rather than by deployment, or state the cap as the boundary and stop describing the isolation as a live control. **The one thing that does not work is describing it as "untouched and still enforced" without re-deriving that**, which is what the register said while two commands were not enforcing it **Answer the Codex switch's scope in the same breath** (2026-09-05): `setCodexBackendEnabled` takes a `groupId` but writes an **installation-wide** config key, and the group id only routes the ledger entry — `readCodexBackendState()` takes no group id at all. Harmless while the cap stands, and if it is lifted, org A's Root switches Codex off for org B while org B's ledger says nothing. Measured in `docs-notes/qa-sweep-2026-09-05/codex-scope-probe.ts`; written up in this file's §"An observation about the Codex switch's scope".                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ~~**T50**~~ | ~~**Kinan then Claude. Nothing automatic runs the full lint gate (finding 237).**~~ **DECIDED 2026-09-09: (c), it stays manual, and `git-hooks/pre-commit` now says after every lint that it is not the full gate** (sweep register C5; struck here on 2026-09-14, five days late). _Original row:_ `git-hooks/pre-commit` runs `oxfmt` and plain `oxlint` over staged files; the type-aware rules, `scripts/` and the CSS check are only reached by `node scripts/run-lint.mjs`, which a person has to remember and which **could not complete on Windows at all until finding 233 was fixed**. The decision is which way to close it: make the hook run the gate (slow. The core shard alone is ~10 minutes, so it would have to be staged-scoped or moved to CI), or leave it manual and correct the five registers that call it "what `git-hooks/pre-commit` runs". **The registers are being corrected either way**; the open question is whether anything should enforce it **Two measurements added 2026-09-07 (ii), because this decision has never had a number attached.** (1) **The full gate takes ~18 minutes on this machine, measured twice** — `node scripts/run-lint.mjs`, 05:24:15 to 05:42:02 and again 05:55 to 06:14, mostly in the twenty per-extension `oxlint` passes, several of which log "still running after 30s". Two samples rather than one, because a single timing of a slow thing is usually a timing of something else. A pre-commit hook that costs eighteen minutes will be bypassed on its first bad day, which makes "put it in the hook" the option that produces a gate nobody runs; CI is where an eighteen-minute check belongs. (2) **The two gates disagreed in this very session, on a change made ten minutes earlier.** Plain `oxlint` over `src ui/src` exited 0. The full gate exited **1** on `typescript(require-array-sort-compare)` — a type-aware rule the plain pass cannot evaluate — against a line that plain `oxlint` had itself demanded (`unicorn(no-array-sort)` asked for `.toSorted()`, and the type-aware rule then asked that `.toSorted()` for a comparator). So the claim "the hook is close enough" is now falsified by example rather than argued about: one gate asked for a change the other rejected. **Whatever is decided, the danger is the middle option** — a hook that runs the cheap subset looks like coverage and is what let this reach a commit-ready state twice today. **A third timing, 2026-09-07 (iv): ~14 minutes, exit 0, clean end to end.** That is the second and third clean runs agreeing, so **~14–18 minutes is the number the hook-or-CI decision should use**; the 45-minute shard cap that run 4 needed on 2026-09-07 (iii) was set again as a precaution and did not bind, which confirms it was load and not the gate's real cost. Read the way this row's own history demands: redirected to a file with `echo "EXIT=$?"` appended, and the whole 86-line log searched for error and timeout lines rather than the tail read — the harness reported "completed (exit code 0)" for the _wrapper_, which is the same notification that was wrong three times in an hour that day.                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ~~**T51**~~ | ~~Should the command line be able to reach the Gateway's runs?~~ **CLOSED 2026-09-07 (iii) by removing the question.** The decision Kinan took was larger than T51: **the governance command line was removed entirely**, so `governance agent runs` and `agent cancel` no longer exist and neither does the surface they were incomplete on. The three options this row listed — give the CLI an HTTP client, remove the two commands, or leave them honest — were all about how far to extend a surface no design requirement asks for. **While surveying it, one real defect was found and is recorded rather than lost**: a comment in `register.governance.ts` stated that `agent cancel` "reaches the _Gateway's_ run registry" and could stop a dashboard-started run. It could not — `cancelPromptRun` reads the same per-process `Map` — and that comment is the one an operator would read _during an incident_, deciding whether they had a narrow tool or only the kill switch. Finding 278's class in a comment rather than a flag. See §"The command line, removed" and `old-docs/removed-cli-surface/`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ~~**T52**~~ | ~~The dashboard, driven by the person using it (2026-09-04).~~ **DONE 2026-09-04**, asked for directly rather than from this list, like T44. Findings **239** (no owner picker on the create-agent form, so Root hit a correct refusal with nothing to act on) and **240** (placeholders clipped mid-word, and the "Create account" button rendered off the visible edge), plus seven requests: a page title, description and Learn more matching Privacy & Security and pointing at this repository; Accounts moved to the top, the kill switch below Active agent sessions and Deployment last; a section jump-nav that reads the rendered page so it cannot link a tier to a section it does not get; the approval timeout widened to Administrator **and** given a per-agent axis so a User can set it for their assigned agents; 7,983 em dashes removed from the 234 files this fork wrote; and a README describing this project rather than upstream. §"The dashboard, driven by the person using it"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ~~**T54**~~ | ~~What should a folder grant normalise against?~~ **DONE 2026-09-04, and none of the four options first written up is what was built.** (Those options and the trap in the third are folded into the session-log entry; the decision document they lived in was deleted once the decision was taken, rather than left to rot as a live-looking question.) Kinan asked for more options and then for the most thorough one. All four originals treat the folder-grant control as the thing at fault; it is one of _three_ places a path becomes a pattern, and the same disagreement lived in the other two. **The fifth option fixes the comparison instead of the writer**: a file inside the workspace has two legitimate names, and which one the canonical form picks depends on the session's working directory, which the rule's author cannot know. Rules are now matched against both spellings and the canonical one is still recorded (`resolveGovernedPathForms`, four call sites). Fixes folder grants, hand-written absolute rules and T7's search withholding at once, with no new data, no migration and no capability removed. The escape-detection property is preserved because a path outside the workspace has exactly one form; there is a test asserting no `..` spelling is ever manufactured. **Building it found finding 254**, a security defect in the self-protecting core tier that nobody was looking for                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ~~**T53**~~ | ~~Split `governance-page.ts`.~~ **DONE 2026-09-05.** The exception's own reasoning was that every remaining candidate "reads twenty or more private fields" — true of the two prop builders and of `refreshData`, and **not true of the conversation cluster, which it never assessed**: five methods touching nine fields, read by one line of `agentPanelProps` and nothing else. Extracted as `ConversationController`, the fourth controller beside the page rather than a new pattern. **735 code lines to 619 against a 700 limit, and the suppression is deleted rather than moved.** Two orphaned doc comments reattached on the way (finding 135's shape), and one regression caught by the kill-switch tests: the first version narrowed `onDraft` to `promptDraft`, and that callback also carries `killAgentId`, so it now routes rather than restricts                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ~~**T62**~~ | ~~How should somebody verify the audit chain without asking the dashboard?~~ **DONE 2026-09-07 (iii), option (b) at Kinan's decision**: `scripts/verify-ledger.mjs`, the one capability of the removed command line that was load-bearing for a design requirement, restored **without restoring a command surface**. **The problem it answers.** Requirement 8 is a tamper-evident record, and finding 268 made the dashboard _report_ the verification rather than assert it — but the dashboard is the same process that holds the ledger, and asking a system whether it has been tampered with is the shape of the problem rather than a solution. Until the command line went there was a second reader; now there is again. **Three properties, each deliberate.** (1) **It imports nothing from `src/`** — plain Node, no build, no dependencies — so it runs when the build is broken, the Gateway is down, or the layer refuses to start, which is exactly when somebody wants to know whether the record is intact; it also runs against files copied **off** the machine, which is the only arrangement that survives an attacker who owns the host (§7 caveat 4). (2) **It does not sign in, and cannot.** The removed `audit verify` required a governance session first, which is the wrong way round for an audit tool: authenticating to a possibly-compromised installation makes the audit depend on the thing under audit. This reads three files. (3) **It re-implements the hashing rather than importing it**, so a defect in `audit-ledger.ts` cannot agree with itself. **The cost of (3) is drift, and a verifier that cries wolf is worse than none**, so `verify-ledger-script.test.ts` pins the two together on real chains: intact, one decision edited on disk, entries deleted from the end, and the checkpoint removed — seven tests, and neutering the hash check fails one while neutering the checkpoint checks fails two. **It answers three ways, not two**: 0 intact, 1 broken, **2 could not check**, because collapsing "I could not check" into either of the others is how a verifier starts reporting infrastructure as tampering, or silence as safety                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ~~**T61**~~ | ~~**Claude: a wrong password is reported as an expired session**~~ **DONE 2026-09-08 (finding 297), by the third option this row recommends.** `GovernanceApiError` now carries whether the failing call was itself an attempt to authenticate, and `isSessionLost` reads it, so a 401 from `login`/`bootstrap-root` is _wrong credentials_ and a 401 anywhere else is still _session lost_. Both halves driven on a running gateway: a mistyped password shows the server's own "Invalid credentials"; a session revoked on disk still clears the page with the expiry banner. **The same session found the third arm this row did not know about** — signing out produced 401s from a refresh batch straddling the logout, reported as an expiry and then as a partial failure, and repopulating the previous account's state behind the sign-in screen (finding 298). Original text follows. **Claude: a wrong password is reported as an expired session** (reported by Kinan 2026-09-07 (ii), on the dashboard). Typing the wrong password at the governance sign-in shows _"Your session ended, so the page was cleared rather than left showing out-of-date information. Sign in again to continue."_ — which is not what happened. Nothing had ended; the credentials were simply wrong, and the operator is told to do the thing they were already doing. **Diagnosed, not guessed**: `run()` in `governance-page.ts` wraps every action, and its `catch` maps any error satisfying `isSessionLost` — that is, **any 401** — to `markSessionExpired()`. The sign-in route answers a bad password with 401 like every other route, so the login action falls down the expiry branch before its own error message is ever read. `governance-page.test.ts` already half-knows this: its sign-out helper says the stub is "deliberately **not** a 401: that would send `run()` down the _expiry_ path". **Three candidate fixes, and the choice matters**: exclude the login call from the generic mapping (smallest, but leaves the trap for the next action added), have `run()` take an explicit "this call authenticates" flag, or distinguish _unauthenticated_ from _session lost_ at the API layer so a 401 from `login` is a different error type from a 401 elsewhere. The third is the one that stops it recurring. **Same family as the whole 2026-09-07 sweep**: a surface reporting a consequence that did not happen. It is also mildly security-relevant in the reporting direction — an operator told "your session ended" may reasonably conclude the system logged them out rather than that they mistyped, which is the wrong mental model during an incident                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ~~**T64**~~ | **DECIDED BY KINAN AND BUILT 2026-09-09: option (a), split the page** — `en-core.ts` loads at startup, `en-governance.ts` travels with the governance page, and `en.ts` merges both for the translation pipeline. 9,019 bytes off every first page load; 4,956 keys verified before and after. See `mg/REMAINING-WORK-DASHBOARD-SWEEP.md` §"T64 done". _Original row:_ **Kinan then Claude: decide whether a page's strings should load with the page** (finding 321, 2026-09-08). `ui/src/i18n/locales/*.ts` is **one module per locale, loaded at startup**, while every page it serves — the governance page included — is **lazily loaded**. So a sentence added anywhere in the product is multiplied across the locale set and charged to the **startup** JS budget, and this project has spent three days deliberately adding operator-facing sentences because unclear text was the defect class being fixed (300, 303, 304, 311, 320). The two pull against each other through a coupling neither is aware of, and finding 321 is what that looks like: the build broken for a day by clarity work, with every source check green. **The ceiling was raised 317 → 318 KiB to unbreak it, which buys 391 B — about four more sentences.** Options: **(a)** split the locale module so a page's strings ship in the page's own chunk — the structurally right answer, matching what the code already does, and a change to upstream's i18n loading; **(b)** move only the `governance:` block out, which is smaller and helps only this fork; **(c)** keep raising the ceiling and accept startup growth, which is honest but is not a plan; **(d)** hold the line on budget and cap how much operator text the layer carries, which trades away the thing findings 296–320 were asked to improve. **(a) or (b) is the recommendation**, and (b) is a day's work at most.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ~~**T63**~~ | **DECIDED BY KINAN AND BUILT 2026-09-11: both (a) and (b), (a) first** — see `mg/REMAINING-WORK-DASHBOARD-SWEEP.md` §"T60 and T63 built". _Original row:_ **Kinan then Claude: decide whether the dashboard should show a prompt whose tab is gone** (finding 316, 2026-09-08). `GET agent/runs` exists, is gated at User tier and scoped to the caller's group and assignment, and its own comment states its purpose: _"so the dashboard can offer a cancel control for a prompt whose original tab is gone."_ `GovernanceApi.listPromptRuns` exists to call it. **No screen calls either**, so the capability is written, tested at the privilege matrix, and unreachable. Hit for real during the Your-agents sweep: a run in flight, the tab reloaded, and the only control left is the **emergency kill switch** — which the comment beside `cancelPrompt` argues at length must not become the way out of an ordinary mistake, because an emergency control used routinely stops being treated as one. **Findings 264–268's class** (a capability the code has and the screen does not offer), and deliberately **not** fixed in that sweep, which was asked to repair bugs rather than add controls. Options: **(a)** call it on load and render any in-flight run of the open agent as the streaming block already looks, with the existing Cancel — smallest, and it only ever shows the account its own runs; **(b)** a row in _Active agent sessions_, which is where an operator already looks for "what is running", though that panel is about the host's sessions rather than this account's prompts; **(c)** leave it, delete the unused client method, and record the route as server-side only. **(a) is the recommendation**: it costs one request on a path that already refreshes, and it closes the gap the route was written for.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ~~**T60**~~ | **DECIDED BY KINAN AND BUILT 2026-09-11: the explanation, option A, and 40 + 20 per account** — see `mg/REMAINING-WORK-DASHBOARD-SWEEP.md` §"T60 and T63 built". _Original row:_ **Kinan then Claude: decide what "Always allow" should tell the operator, and what a full proposal queue should do** (finding 281, 2026-09-07). Two halves, both about what the person pressing the button is told. **(a) The label.** Since 2026-09-06 `allow-always` grants the call and files a **rule request** an Administrator approves; the button still reads **"Always allow"** and the escalation text — _"Agent X wants to run Y against Z, which no policy rule currently covers"_ — says nothing about a proposal. So the control promises a consequence it does not have, which is finding 278's `--skip-ui` class and caveat 19's. The string is upstream's (`execApproval.alwaysAllow`) and is shared with the host's own always-allow, where it _is_ permanent, so the fix belongs in the governance escalation's own `description` rather than in the shared label. **(b) The queue.** Every proposal is filed under the one labelled origin `hitl-approval`, and `MAX_PENDING_REQUESTS_PER_USER` counts by requester, so all of them share **a single 20-slot budget for the whole organisation**. Measured 2026-09-07: 25 distinct escalations answered Allow always filed **20** proposals; the other five granted the call and filed nothing, recorded only as an `escalation-proposal-failed` ledger entry that no surface reads. Options: raise or separate the budget for the labelled origin; report the failure to the operator on the surface they pressed the button on; or state it as a documented limit. **The safe half is already true and should not be lost in the fix — a full queue never widens the policy, it only fails to propose.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ~~**T68**~~ | **DECIDED BY KINAN AND BUILT 2026-09-13: option (b).** A dashboard prompt's escalation is answered on the governance page, only by the accounts that manage the agent, and recorded under that account; no other Gateway connection sees it, only the agent run that asked. See `mg/REMAINING-WORK-DASHBOARD-SWEEP.md` §"T68". _Original row:_ **Decide who may answer an escalation raised from a dashboard prompt (2026-09-13).** Today, any Control UI holding the Gateway credential; limiting it to the accounts that manage the agent is a design change. See `mg/REMAINING-WORK-DASHBOARD-SWEEP.md` C11 and `mg/HANDOFF.md` caveat 27                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ~~**T69**~~ | **DECIDED BY KINAN AND BUILT 2026-09-13: option (a).** The approval hook withdraws its approval when its run is aborted, through a new `plugin.approval.withdraw` Gateway method only the requester may call; the card closes, and a chat channel is told the request was cancelled rather than denied (finding 363, fixed). See `mg/REMAINING-WORK-DASHBOARD-SWEEP.md` §"Finding 363". _Original row:_ **Decide whether a requester may withdraw an approval it no longer needs (finding 363, 2026-09-13).** A cancelled task's approval card stays pressable until it expires; the fix is a `plugin.approval.withdraw` Gateway method. See `mg/REMAINING-WORK-DASHBOARD-SWEEP.md` C12                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **T59**     | **Kinan then Claude: make per-agent models work, and prove they do** (2026-09-07). Upstream supports it — each agent entry carries its own `model`, `createAgent` writes it, and the create-agent form has asked for one since finding 265 — so **the capability exists and nothing has ever exercised it**. What is unverified is the whole path: that a model named at creation is actually the one the agent runs on, that leaving the field blank still inherits the installation default, and that two agents on two different providers both reach the gate identically. The last of those is the one that matters for the report: §3.5 claims the gate is **provider-agnostic**, that it "inspects a command, a path or a hostname and knows nothing about which model produced it", and that claim has only ever been argued. Two agents on different models, both refused by the same rule, is the measurement that turns it into evidence — and it is a stronger Chapter 4 artefact than T2 alone. **Also settle whether the auth profile follows**: `paste-api-key` resolves per agent directory and a second provider needs its own credential, so "different models" may mean "different keys" and the form says nothing about that. Reported by Kinan after creating `jack` and finding it on the same Kimi connection as `andrew` — which is correct behaviour, since both inherited the default, but the surface gave no way to tell that from a shared identity                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **T58**     | **Kinan then Claude: settle whether `edit` is ours** (2026-09-07). Jack's own tool sweep on the VPS reported `edit` failing with **ENOENT on a file `write` had just created**, and neither of us has checked it. **The method is the one that settled `exec`, and it is three seconds of looking**: filter the audit ledger to Agent actions and find the `edit` call. An entry with `deny` and a rule means governance refused it and names the rule; an entry with `allow` that still failed means the gate passed it and the fault is downstream in upstream's tool; **no entry at all** means it never reached the gate. Reasoning says it is unlikely to be ours — the gate rewrites a path parameter only when canonicalisation actually redirects it, which needs a symlink, and leaves every ordinary call byte-identical — but that is an argument and the ledger is a measurement. **The same sweep reported `apply_patch` broken and it is not**: Jack sent unified diff to a tool that wants its own format, and governance never touches its paths, which are host-derived and explicitly excluded from param rebinding. `memory_search` degrading to keyword search is a missing embeddings key, not a defect. **And `exec` "recovering on its own" is finding 274, not a fix**: something restarted and reloaded a working `dist`; nothing clears `dist/`, so a partial build can leave that state again                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ~~**T55**~~ | ~~**Decide what a reused agent id should inherit**~~ **DECIDED 2026-09-08 by Mohammad, and built.** Two removals, opposite answers, and the difference is the decision. **"Remove from governance" keeps everything** — the agent still exists on the host and can still act, so clearing its rules would disarm a live workload, which is the dangerous direction and is what `unregisterAgent`'s own comment already argued. **"Delete the agent" clears everything the id carried** — OpenClaw has deleted the agent, so those rules protect nothing and can only bind a stranger who inherits the name. **Five fields, not the three the 2026-09-05 sweep measured**: the document also keys the per-agent escalation override and its timeout, and nobody had ever asked about those; measured before deciding (finding **324**), they inherit identically. Global rules are untouched, the ledger is never touched, and the clearing writes its own entry naming what went, because clearing a permission is an administrative action and requirement 5 asks for all of them. Ordered host-delete → unregister → clear, so a failure earlier leaves the rules around an agent that still exists; a failure at the clear is reported rather than thrown, leaving the pre-T55 state and telling the operator they have a cleanup. **Part (b′)**: creating or registering an agent onto a loaded id appends one clause to the existing confirmation — _"That id already carried 2 rule(s), an active stop, which now applies to this agent."_ A **warning dialog was considered and rejected**: the commonest reason a fresh id already has rules is that the operator wrote them minutes earlier on purpose, so it would mostly fire on people who already know, and a warning that is usually wrong teaches everyone to dismiss it. 9 tests in `src/governance/agent-policy-lifecycle.test.ts` (3 fail against the unfixed code; the other 6 guard against overreach and pass either way on purpose), plus `docs-notes/qa-sweep-2026-09-08/t55-delete-clears.ts` 8/8. **The 2026-09-05 sweep was relabelled rather than left red**: it drives the unregister path, so its three "does NOT inherit" checks now assert the survival and it is 5/5 — finding 318's lesson applied before it could recur. ~~Original row: Kinan: decide what a reused agent id should inherit~~ (finding 258, 2026-09-05). Measured: register `scout`, give it an agent-scoped **allow** on `/srv/payroll/**`, a `monitor` posture override and a lockdown; unregister it; register a new agent under the same id. The new agent arrives holding all three. `unregisterAgent` says in its own doc comment that this survival is deliberate — "the registry never owned those" — and for plain unregistration that is right, because the agent still exists on the host and disarming its rules is the dangerous direction. The case that reasoning does not cover is **re-registration under a reused id**, where the id names a different agent, and no test anywhere asserts it, so it is unasserted behaviour rather than codified intent. Three options: purge agent-scoped policy on `deprovisionAgent` when `deleteFromHost` is set (the agent genuinely no longer exists); warn at registration when the id already carries policy; or keep it and write the reasoning down so the next sweep does not re-find it. **Left open rather than fixed on purpose**: this changes deletion semantics, which is a product decision like T49 and T50, not a repair. `docs-notes/qa-sweep-2026-09-05/agent-lifecycle-sweep.ts` is the measurement, 2/5 |
| ~~**T56**~~ | ~~Claude, once Kinan says which surfaces: say when the pending stack has dropped rows.~~ **DONE 2026-09-07 (ii)**, on both listing surfaces. **The decision this row asked for turned out not to exist**, which is worth more than the fix: it said "all three consumers of `listPendingDecisions`", and only **two of the three are listings**. `governance-dashboard-api.ts:447` is a lookup by id for the decide route — it displays no worklist and has nothing to be incomplete about. So the real choice was "both listings or only the dashboard", and leaving the command line silent would have left it stating "No escalations are waiting for a decision" over a stack that had dropped questions. Built as: `pending-decisions.json` gains a cumulative `shedUndecided` counter, incremented **inside the same lock that did the shedding** so the count and the rows can never disagree; `pruneDecided` returns what it shed rather than a separate tally being kept beside it; a single `readPendingDecisions` returns rows and count from one read, with `listPendingDecisions` delegating to it so no surface can print the two from different moments; and `describeShedPendingDecisions` is shared by the command line and (through i18n) the dashboard, because finding 255 caught those two describing one thing in different words already. **Three properties worth keeping:** only _undecided_ rows are counted, since losing a decided one costs an operator nothing to act on; the count is cumulative rather than "what is missing now", because the rows are gone and cannot be recovered; and the dashboard panel now renders **when there is a count and no rows**, which is the case its own empty check would otherwise hide — a flood shed and then answered leaves nothing waiting _and_ an incomplete record, and "nothing is waiting" is exactly the reading that must not be taken from it. Six store tests and three panel tests, all revert-verified: neutering the counter fails three of the six, neutering the notice fails two of the three                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ~~**T57**~~ | ~~Record and govern a prompt whatever surface it arrives on.~~ **DONE 2026-09-06**, at Kinan's decision: the **labelled-origin** option. `src/governance/host-prompt-audit.ts` records a prompt that reaches an agent with no governance account behind it, under `HOST_PROMPT_ACTOR` (`host-prompt`), which joins `cli`, `bootstrap`, `hitl-approval` and `unauthenticated` in `RESERVED_ACTOR_NAMES` so no real account can produce an entry that reads as an anonymous one. The **channel** is named in the entry, so an auditor learns the surface without it being dressed up as an identity. Hooked into `agentCommandInternal`, the single funnel every agent turn in the process passes through — the local command path and every ingress path alike — which makes it the prompt-side equivalent of `runBeforeToolCallHook`. Two exclusions: runs stamped with the `governance` channel (already in the chain under the account that sent them, a strictly better entry) and raw model runs (machinery, not instruction). **Both of the two open behavioural questions were settled by precedent rather than by judgement, and one answer changed as a result.** An agent with no group is **recorded into `INSTALLATION_LEDGER_GROUP`**, not skipped, because that is what the gate does in the same situation and its comment gives the reason — "requirement #5 asks for every action, and 'an unregistered agent tried to act' is exactly the one an operator needs"; the first draft skipped it silently, which would have made the case an operator most needs the one case nothing records. The prompt is **not** refused there, because the gate refuses every tool call such an agent makes and duplicating enforcement is how the second copy goes stale. A failed ledger write **stops the turn**, which is the gate's own answer: its `catch` returns `blocked: true`. The gate's `isUnconfiguredTestRun()` exemption is taken verbatim. **9 tests**, including a wiring guard in the shape of `client-callsites.guard.test.ts`, because the other eight call the recorder directly and would all keep passing if the hook were deleted                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
> **Current answer, re-derived 2026-09-14: see §"Where this file stands" at the top.**
> Ten open. T46, T58 and T59 need Kinan first and then work for Claude; T3, T13, T17,
> T18, T48 and T49 are Kinan's; T47 needs all three; T1 is not being done. **The block
> below is the 2026-09-07 (iii) answer, kept as history**: T50, T55, T60 and T61 have
> all closed since.
>
> _As it stood on 2026-09-07 (iii):_ fifteen open, sorting into four categories rather
> than three:
>
> - **Claude can finish alone: one.** **T61** — a mistyped password is reported
>   as an expired session. Already diagnosed (`run()` maps any 401 to
>   `markSessionExpired()`), so it is work rather than a question.
> - **Needs a decision from Kinan, then Claude builds it: five.** **T46** (how
>   far the wizard's branding goes), **T50** (whether anything enforces the full
>   lint gate — now with two measurements attached), **T55** (what a reused agent
>   id inherits), **T59** (per-agent models, and whether the form should warn
>   when a provider has no credential), **T60** ("Always allow" wording and the
>   shared proposal budget).
> - **Only Kinan can do it: eight.** **T3** (re-run the suite on the Linux host),
>   **T13** (a read), **T17** (the figures), **T18** (the report), **T48** and
>   **T49** (two judgements), **T58** (three seconds of looking at the VPS
>   ledger), and **T1**, which is not being done.
> - **Needs all three of you: one.** **T47**, the by-hand test plan — 158 checks,
>   three people, three machines.
>
> **The shape of the list has changed.** For most of this project the honest
> answer was "everything open is Kinan's". It is not any more: six of the fifteen
> have work for Claude behind a decision, and one needs no decision at all.
>
> **The "Claude can finish alone" category has emptied three times and refilled
> three times**, which is the
...
| **T17**    | Redraw the Mermaid diagrams                                                                                                                                                                                                              | Whether Claude drafts them for you to approve, or you draw them. The candidates are already marked in `CHAPTER3-MATERIAL.md` **The audit half is done (2026-09-06)**: all 21 figures compared against the code and checked for completeness. All three forms present for every one — F18 carries none and correctly so, being a CUT cross-reference. **Two defects fixed**: F21's TikZ would not have compiled (five line breaks had lost a backslash, so LaTeX read ``, `ackend` and three more as undefined control sequences), and F12 claimed an installation may hold more than one organisation, which the 2026-08-30 cap made false — the same correction F2 had already had, applied to the figure the claim actually belongs to. **What remains is yours**: whether to redraw them, or to have Claude draft the 21 for approval. The remaining risk is that nobody has _compiled_ them; that needs a LaTeX toolchain this machine does not have. |
...
| ---------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| ~~**T2**~~ | ~~Run it once with a real agent~~  | **DONE 2026-09-06.** Kimi drove `jack` at a credential file on the VPS; the gate refused it, entry #25 names the rule                             |
| **T3**     | Re-run the suite on the Linux host | The VPS exists and runs the fork (2026-09-03). What is left is the measurement, not the deploy. The one design requirement (#9) not yet fully met |
...
~~**T2 is the highest-value item left on the whole project**~~ — **done on
2026-09-06**, and it held that place from 2026-08-19 until then. It converts the layer from _tested_ to _demonstrated_, and
...
stays in the repository as `old-docs/UPSTREAM-BUG-REPORT.md`, which is what Chapter 4
...
| ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- | ------- | ------ |
| **T1** | ~~**File the OpenClaw bug report upstream.**~~ **DEPRIORITISED 2026-08-22, not doing it.** The report is written, verified pre-existing, and stays in the repository as `old-docs/UPSTREAM-BUG-REPORT.md`, which is what Chapter 4 §4.x.7 cites; filing it upstream adds nothing to the project and needs an account. Lowest priority of anything on this list | F4  | You     | -      |
...
| #          | Task                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Ref  | Blocked   | Effort   |
| ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | --------- | -------- |
| ~~**T2**~~ | ~~**Run it once with a real agent, and record what happens.**~~ **DONE 2026-09-06, on the VPS.** Kimi drove agent `jack` at `~/.npmrc`, the gate refused it, and ledger entry #25 names the rule. _(This row read "no language model has driven a tool call through it" until 2026-09-07, a day after that stopped being true. Five copies of the same claim were struck the night T2 landed and **this one, `:365`, `GOVERNANCE.md` §4.x and `CHAPTER3-MATERIAL.md` §3 were not** — finding 282. A claim written into more than one table is corrected in the table the person was looking at.)_                                                                            | A9   | You       | 2–4 days |
| **T3**     | **Deploy to a real Linux host. Half done since 2026-09-03: the fork is installed and running on a VPS**, and T2 was demonstrated there. What remains is re-running the suite on that host — the last Linux measurement is 2,548 / 133 and predates T44 and five sweeps. This is the one design requirement (#9) not yet fully met. `governance deployment` (A7) gives it a ready verification step. _(Read "nothing has run on a VPS" for four days after the deployment; finding 282.)_                                                                                                                                                                                     | A8   | You (VPS) | 3–5 days |
...
| #       | Task                                                                                                                                                                              | Ref | Blocked                                 | Effort                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **T17** | **Redraw the Mermaid diagrams in the report's own style.** Candidates are already marked "Figure candidate" throughout `CHAPTER3-MATERIAL.md`                                     | F5  | You (or a decision to let Claude draft) | 2–3 days **The audit half is done (2026-09-06)**: all 21 figures compared against the code and checked for completeness. All three forms present for every one — F18 carries none and correctly so, being a CUT cross-reference. **Two defects fixed**: F21's TikZ would not have compiled (five line breaks had lost a backslash, so LaTeX read ``, `ackend` and three more as undefined control sequences), and F12 claimed an installation may hold more than one organisation, which the 2026-08-30 cap made false — the same correction F2 had already had, applied to the figure the claim actually belongs to. **What remains is yours**: whether to redraw them, or to have Claude draft the 21 for approval. The remaining risk is that nobody has _compiled_ them; that needs a LaTeX toolchain this machine does not have. |
...
`CHAPTER3-MATERIAL.md` measures that diff, **316 files, 125,135 insertions, 349
deletions as of 2026-09-06**, split there into 48 prose files and 214 in the
governance layer proper. Deleting upstream's CI would falsify that
...
unpublished academic work.~~ **Overtaken by a decision, 2026-09-04: Kinan made
the repository public.** Not for the minutes — for the dashboard's **Learn
more** link, which pointed at a repository only its owner could open and was
therefore a 404 for every reader the link exists to serve. The reason this
sentence gave still stands as a _consideration_ (the work is now visible before
submission) and it is Kinan's call to make; it is recorded here rather than
deleted, because the argument was sound and the decision was taken against it
knowingly.

**Two consequences, and the second needs attention.**

**The good one:** the VPS clone no longer needs credentials. `LINUX-INSTALL.md`
§1, generating a deploy key on the server and registering it on GitHub, was the
only setup step in the whole runbook that a person had to perform by hand on two
machines, and it is listed as item **f**, "yours to execute". It is now a
skippable section; the clone is plain HTTPS.

**The one to look at:** minutes stop mattering on a public repository, and
something else starts. `pull_request` and `pull_request_target` workflows were
unreachable while the repository was private, because a stranger could not open
a pull request. Now they can. **Six of the 82 inherited workflows use
`pull_request_target`** — `auto-response`, `clawsweeper-dispatch`,
`dependency-guard`, `labeler`, `real-behavior-proof`, `security-sensitive-guard`
— which is the standard privilege-escalation vector on a public repository,
because it runs with the base repository's permissions and secrets.

**Measured rather than assumed, and the answer is reassuring**: none of the six
checks out the pull request's head, which is the half that makes the pattern
dangerous, and five reference GitHub App secrets that exist only in upstream's
repository. A stranger's pull request would start them, they would fail for want
of secrets, and no attacker-controlled code would run. **The exposure is bounded
and needs no change today.** What it needs is to be known, because "we inherited
82 workflows and disabled Actions" was a billing decision and is now also a
security one.

**And T21's claim is stale.** It records Actions as disabled on 2026-08-22,
proved by the billing curve. The API says otherwise on 2026-09-04: all workflows
report `state: "active"`, there are **425 runs**, and 9–10 land every day
without a break from 2026-08-23 to today, including scheduled ones. The hourly
sweeper did stop, which is what the billing figures actually showed; the
scheduled and Dependabot runs did not. Re-measure before repeating T21, and see
the note under it.
...
defects**, and both are closed — T29's numbering half on 2026-08-26 and its
register-coverage half on 2026-08-28. _(This sentence said the coverage half was
"still open" for ten days after it closed. The row below has said DONE IN FULL
throughout.)_
...
- ~~**The end-to-end ordering is reasoned, not observed.**~~ **Observed on
  2026-09-06, and the reasoning was wrong.** `llm_output` does **not** fire
  before the same turn's tool calls, so the intent standing at the gate belonged
  to the previous turn — finding 273, visible in the very entry that proves T2.
  The claim struck here, "the field is populated or absent, never wrong", was
  the load-bearing one and it was false. Fixed by clearing the standing intent
  at the start of every turn, which makes it true.
- ~~**The dashboard does not surface it.**~~ **It does.** The ledger panel renders
  the intent under each entry's description, labelled _"Agent said"_
  (`oversight-panels.ts`, `governance.ledger.intent`). _(Recorded as open here
  until 2026-09-07 (ii); measured by reading the panel rather than this
  paragraph.)_
...
**The T2 preparation kit** is `old-docs/T2-LIVE-RUN.md`. T2 is the highest-value
...
| 8   | T2 preparation kit            | `old-docs/T2-LIVE-RUN.md`                                                               |
...
> **⚠ This table describes 2026-08-28 and was overtaken twice** (annotated
> 2026-09-08 (viii), finding 336). The three `linux-*.sh` scripts it names were
> **renamed** that same day to `scripts/wsl-dev-setup.sh`, `wsl-dev-sync.sh` and
> `wsl-dev-test.sh`, and **superseded** by `scripts/vps-install.sh`, which does
> the thing this table says is missing: it builds. And the conclusion under the
> table — that the Linux evidence is "unit tests plus a built-ins-only probe" —
> stopped being true on **2026-09-03**, when the fork was installed and started
> on a real VPS, and again on **2026-09-06**, when T2 was demonstrated there.
>
> **Kept rather than rewritten**, because the analysis is what made the case for
> `vps-install.sh` and it reads as the argument it was. What remains true is the
> narrow part: **the full suite has still not been re-run on Linux**, and that
> is what is left of T3.
...
| f   | ~~**Deploy-key access for the private repository.**~~ **NOT NEEDED since 2026-09-04**, when the repository was made public: the clone is plain HTTPS and needs no key, so `LINUX-INSTALL.md` §1 is now a section to skip. This was the only setup step in the runbook that had to be done by hand on two machines, and the only one on this list marked "yours to execute". The deploy-key procedure is kept, collapsed, in case the repository is ever private again                                                                                                                                                                             | 15 min   | yours |
...
own history: the upstream bug in `old-docs/UPSTREAM-BUG-REPORT.md` is a POSIX-vs-Windows
...
`old-docs/email-to-supervisor-t7.md` asks Dr. Haitham whether forking a second project
...
`old-docs/SESSION-LOG-2026-08.md` all said "both relay call sites", which a reader takes to
...
`old-docs/email-to-supervisor-t7.md`. **Nothing in this section decides the item**. It
...
Pushed to `https://github.com/KinanRadaideh/openclaw-governance-layer`,
added as the remote `personal`. It was **private until 2026-09-04** and is public
from that date, so the dashboard's Learn more link resolves for a reader who is
not its owner. `origin` is untouched and still points at
...
`old-docs/UPSTREAM-BUG-REPORT.md` is written and unfiled. Needs a GitHub account to
...
section of this file and `old-docs/SESSION-LOG-2026-08.md`. Items marked done
...
| Ref | Item                                                                                                                                                                                                                                                                                                                                                                   |
| --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| F1  | ~~**Create a private git remote and push.**~~ **DONE 2026-08-21.** Pushed to `KinanRadaideh/openclaw-governance-layer` as remote `personal`; `origin` untouched. **Public since 2026-09-04**; it was private until then. Verified by cloning it back: same tip and tree. The work now exists off-site. This was the one item whose failure mode was losing everything. |
| F4  | File `old-docs/UPSTREAM-BUG-REPORT.md` upstream. Written, unfiled; needs a GitHub account.                                                                                                                                                                                                                                                                             |
...
## The dashboard, driven by the person using it (2026-09-04)

**T52. Findings 239 and 240, plus seven requests. All done.**

Kinan signed in as Root on the VPS and tried to create an agent. Everything here
came out of that hour, and the narrative is in `SESSION-LOG-2026-09.md`
§2026-09-04 with the plain-language version at `QA-IN-PLAIN-TERMS.md` §5.96.

### 239: the form that could not be completed

Root filled in the create-agent form and was told _"The agent could not be given
an owner: agents are owned by an Administrator"_. **The refusal is correct** and
M4's rule behind it is right: exactly one Administrator answers for each agent,
and Root is deliberately not eligible.

The defect is that the screen offered nothing to satisfy it with. The route has
accepted `adminId` since M6, the CLI has had `--owner <accountId>` for as long,
and `AgentRegistryPanelProps` already declared `administrators` with the comment
**"Accounts that may own an agent, for Root's owner picker"**. The picker did not
exist; the comment described a control nobody built.

Fourth occurrence of the class, and the file's own header states the rule it
broke: _"a capability is finished when something an operator can click uses it,
not when the route returns 200."_

**Fixed**: a dropdown of the organisation's Administrators, Root only; the
prompt "First create an Administrator account in Accounts" when there are none;
and the submit disabled until an owner is chosen, so the form cannot post a
request the server will refuse.

### 240: text boxes narrower than their own text

Placeholders clipped mid-word, and the "Create account" button rendered outside
the visible edge. One cause: `.settings-row__control` centres its children and
refuses to wrap. In the stacked create-agent form that centring is the **cross**
axis, so each input shrank to its default `size` attribute, which has nothing to
do with its placeholder; in a crowded row, no wrapping left the last control
nowhere to go.

**Fixed in two halves, both required.** `styles/governance.css` stretches stacked
controls, floors inputs at `min(100%, 24ch)` and lets rows wrap.
`lib/input-overflow-title.ts` gives any clipped text box a hover `title`,
measured against the element's computed font with a canvas, because
`scrollWidth` reflects the **value** and the clipped string is almost always the
**placeholder**.

Pinned in real Chromium. jsdom reports every width as zero, so the same
assertions there would pass against a page with everything clipped, which is
finding 224's trap. The assertion is a deliberate disjunction, **fits or is
labelled**; mutation removing the tooltip fails three of six.

### The seven requests

Page title, description and Learn more matching Privacy & Security and pointing
at this repository. Accounts to the top, kill switch below Active agent
sessions, Deployment last. A section jump-nav that reads the rendered page, so it
cannot offer a tier a link to a section it does not get. The approval timeout
widened to Administrator and given a **per-agent** axis (`agentHitlTimeout`) at
the User floor, because "a User sets it for their assigned agents" cannot be
written on one installation-wide number. 7,983 em dashes removed from the 234
files this fork wrote, with the 42 upstream files it merely patched deliberately
left alone. A README describing this project.

### The rule worth keeping

**Neither defect is about what the code computes**, which is why nothing in the
verification set could see either. Three consecutive days now, and each day's
best findings came from a different place than reading: a cold machine
(230-232), the checking machinery itself (233, 237), and an operator with a
keyboard (239, 240).

## An observation about the Codex switch's scope (2026-09-05, not a defect as shipped)

**Asked by Kinan while reviewing T47, and settled by measurement rather than by
reading:** `docs-notes/qa-sweep-2026-09-05/codex-scope-probe.ts`.

**There are two Codex controls and only one of them is scoped the way its
signature suggests.**

| Control                                                  | Stored where                                                    | Actually scoped                                                                                      |
| -------------------------------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `setAgentCodexAllowed(agentId, allowed, groupId, actor)` | `codexAllowed` on the agent's row in the registry               | **Per agent**, genuinely. Measured                                                                   |
| `setCodexBackendEnabled(groupId, enabled, actor)`        | `plugins.entries.codex.enabled` in the **OpenClaw config file** | **Per installation.** The `groupId` selects which ledger the entry is written into, and nothing else |

The clearest evidence is in a type signature rather than in behaviour:
**`readCodexBackendState()` takes no group id at all.** There is only one stance
to read, so there is nothing for a group id to select. A per-organisation setting
would need one on the way in as well as on the way out.

**This is not a defect as shipped, and the reason is the cap.** Since 2026-08-30
an installation holds exactly one organisation, so "this installation" and "this
organisation" name the same thing and the two scopes cannot disagree. The ledger
routing is then exactly right: the entry belongs in the only chain there is.

**What it is instead is a latent mismatch of the same class as findings 234 and
235**, and it belongs to **T49**, the open decision about what the multi-tenancy
machinery is for. If the cap were ever lifted:

- Org A's Root switching the Codex backend off would switch it off for **org B**,
  whose agents would stop being able to use a harness nobody in org B disabled.
- **Org B's ledger would contain no record of why**, because the entry went into
  org A's chain. An investigation in B would find a capability that stopped
  working and nothing at all explaining it — which is this project's worst bug
  class, arriving as a consequence of a scoping decision rather than a bug.

**Recorded rather than fixed, deliberately.** Making the backend switch genuinely
per organisation means either a per-group config surface that OpenClaw does not
have, or refusing the control to all but one organisation. Both are product
decisions on top of T49 rather than repairs, and neither is reachable while the
cap stands. What should not happen is the mismatch being discovered later and
treated as a surprise: it is written down here so that whoever answers T49
answers this in the same breath.

**Answered with T49 on 2026-09-15 (option b).** The switch is installation-wide by design
and is one of the two reasons for the one-organisation cap; the report says so, and making
it per organisation belongs to Chapter 5's future work (`docs-notes/CHAPTER3-MATERIAL.md`
§3.5.89).

_(The probe also cost two fixture errors worth noting: an agent is owned by an
**Administrator** and `assertOwnerEligible` refuses a Root owner; and
`setAgentCodexAllowed` takes `(agentId, allowed, groupId, actor)`, which was
written the other way round first. `tsgo` would have caught the second and `tsx`
did not, which is finding 257's lesson met twice in one week.)_

## Where this file's findings stop, and where 241–304 are (recorded 2026-09-05, extended 2026-09-06 and 2026-09-07, twice)

**This file's finding write-ups end at 240.** Findings **241–304** are not in it,
and until this section existed nothing here said so.

That is finding **228**'s exact shape, one register over: 228 was
`GOVERNANCE.md` silently never receiving the ninth sweep's findings, so a reader
auditing from that file alone was short and was not told. This file had been
doing the same thing since 2026-09-04, so the correction is recorded here rather
than fixed by backfilling fifteen thousand words.

**Where they actually are:**

_(The rows below were **two** tables until 2026-09-07 (ii): a blank line after
the 264–268 row started a second, headerless one, which renders as a broken
table, and its rows ran **descending** while the first half ran ascending. Both
halves were correct and the register read as though it stopped at 268. Joined and
sorted here — the same class as everything else in this register, a fact that is
right in the file and wrong on the page.)_

| Findings          | Where                                                            | What they came from                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ----------------- | ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **241–252**       | `SESSION-LOG-2026-09.md` §"2026-09-04 (ii)" and §"(iii)"         | The dashboard measured in a real browser instead of read. One of them explains the other eleven: the only test that can see layout was collected in jsdom and skipped silently every time, and Playwright's browsers had never been installed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **253, 254**      | §"2026-09-04 (v)" and §"(vi)"                                    | A file inside a workspace has two legitimate names and rules only ever compared one. **254 is a core denial Root cannot switch off that matched nothing** when the governance store was relocated inside an agent's workspace                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **255**           | §"2026-09-04 (vii)"                                              | A three-surface parity sweep: the command line offered a command needing an account id that nothing on the command line could print                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| **256–259**       | §"2026-09-05"                                                    | The **time** axis: what happens to state after the thing it describes is gone. **256** is a released username carrying the previous holder's transcript, escalation override and login lockout to whoever is given that name next                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| **260, 261**      | §"2026-09-05 (ii)"                                               | The **bounds** axis (what does each cap shed, can it be aimed) and a contention sweep. **260 is finding 225 one store over**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| **262, 263**      | §"2026-09-05 (iii)"                                              | Two guards added while closing T53: the deployment report now asserts the gate is **armed** (a `VITEST` variable with no governance directory disables it silently, enforcing nothing and recording nothing), and the dashboard's hand-copied deployment types are pinned type-level                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **264–268**       | §"2026-09-06"                                                    | **An operator using the dashboard.** Every one is a capability the code had and the screen did not offer, three of them advertised in text while unreachable. **268 is the one to read**: verifying the audit chain reported "Intact, entries verified" and nothing else, so requirement 8's own output had to be taken on trust                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **269, 270**      | §"2026-09-06 (ii)"                                               | **A second operator sitting, and the sweep off the back of it.** **269** is three symptoms with one cause: two inputs in the conversation panel wrote their keystroke onto the props object `agentPanelProps()` rebuilds every render, so the value reached no state and fired no re-render — Send stayed dead with a message typed, the chooser's Talk stayed dead with an id typed, and because one field served as both "what is typed" and "which conversation is open", the box filled itself in and Talk acted as Close. **270** is the same shape on the emergency stop, found by sweeping for the class rather than reported                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **271, 272**      | §"2026-09-06 (iii)"                                              | **The sign-out that cleared three things of fifteen, and a reply nobody could read.** **271**: signing out cleared `identity`, `ledger` and `policy` while session _expiry_ cleared fifteen, and the page is not torn down by signing out — so the next account to sign in **in the same tab** was rendered against the previous one's account list, pending decisions and **agent conversation transcript**. The transcript is the one piece `refreshData` never reloads, so it stayed on screen indefinitely. `ConversationController.forget` was written for exactly this, says so in its own comment, and **had never been called by anything**. **272**: an agent turn with no text rendered as a blank line, and empty is a real outcome rather than a fault — it is what happens when every tool call was refused, which is the one case this layer exists to produce, so the successful demonstration of a default-deny gate looked like a broken page                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **273–275**       | §"2026-09-06 (iv)"                                               | **From the first live run, and from sweeping around it.** **273** (**fixed 2026-09-07**): the raw LLM intent belonged to the **previous turn**. `completeEmbeddedAttemptResult` records it in the settle phase, after that attempt's tool calls have already been judged, so the value it stores reaches the _next_ turn's calls — `readAgentIntent`'s own comment claimed it "is replaced on the next turn, which is when it stops being true", and the replacement lands one step too late for the first attempt. Visible in the very ledger that records T2: entry #25, a refused read of `.npmrc`, carried the model's refusal of a **different file** from twenty-five minutes earlier, so the entry reads as though the model declined when the model attempted it and the **gate** stopped it. A mismatched intent is worse than an absent one, because §1.6 asks for the field so the trail can be read as "it said it was doing X, and then did Y". **Fixed by dropping the previous turn's value at the turn funnel**, which converts a wrong intent into an absent one — absence is already documented as normal — while later calls in the same turn still carry that turn's narration. **The limitation is stated rather than papered over**: the first call of a turn now carries no intent, and populating it would mean capturing the assistant text as it streams, which is a larger change into the runner and unmeasured. The claim that now holds: an intent that is present belongs to the turn that produced the call. Reverses finding 134's deletion of `forgetAgentIntent`, which was removed for having no caller; this one has one, and is for the turn boundary rather than session end. 5 new tests including a wiring guard, run against the reverted code first: 5 failed, 19 passed. **274**: nothing in the build ever clears `dist/` — no clean step, no `emptyOutDir` — so a build that dies partway (the README already warns it is OOM-killed under 8 GB) leaves new chunks beside old ones and a reference that resolves to nothing; on the VPS this broke `exec` entirely with `Cannot find module .../bash-tools-O2NWTdBu.js`. **The ledger's silence was the diagnosis**: the gate records every invocation, so a governance refusal is in the chain by construction, and nothing there meant the failure happened before a tool call existed to gate. **275**: three tests in `src/agents/agent-create.test.ts` fail on the committed tree, unrelated to any change here, confirmed with the working tree fully stashed — outside the seven verification commands, which is exactly the caveat those commands carry                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **276**           | §"2026-09-06 (v)"                                                | **Finding 83 re-opened at Kinan's decision, and answered differently rather than reversed.** An escalation offers `allow-always` again. Finding 83 had removed it because answering it called `addRule`, so one button on an approval prompt wrote a permanent rule into `policy.json` — and that prompt renders on chat surfaces where the person pressing it holds no governance account and sits in none of the four tiers. **That analysis was re-checked and still holds**: the approval broker returns a decision and no identity. So `allow-always` now grants the call in the moment and files a **rule request** — a proposal an Administrator or Root approves on the dashboard, signed in and recorded against them. Requirement 5's administrative approval keeps meaning one party asked and another granted. Three properties carry the security of it, each a way it could otherwise grant more than the prompt displayed: the pattern is the resource **escaped and anchored** through `escapeRegExp`, so approving permits that exact string and not a family; the request is **scoped to the agent**, since one without an agent asks for an installation-wide rule; and the access half rides along, so an escalated read proposes a read. Filed under `HITL_ACTOR`, a labelled origin — the existing guard proved this matters by throwing `FabricatedActorError` when it was passed as a named actor. **`HITL_ACTOR`'s own comment ended "do not reintroduce a writer for it without re-opening finding 83", which is finding 170's fix acting as a tripwire for exactly this change**; it was re-opened first and the comment now records the outcome. 9 tests, run against the reverted code first: 6 failed, 3 passed — the three that stay green assert behaviour predating the change                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **277**           | §"2026-09-06 (vi)"                                               | **A race on the ledger key, found by refusing to re-run a slow test.** The capacity case "does not let one account's flood block another account" timed out at two minutes carrying `LedgerKeyUnusableError: it contains characters that are not hexadecimal` — about a key that was valid moments later. `HANDOFF.md`'s standing rule from finding 169 says a capacity test failing under load is worth more than a re-run, and a re-run would very likely have passed and buried this. **The mechanism:** `writeFile(..., { flag: "wx" })` makes the key file **exist before it holds anything**, so a second caller's `EEXIST` says only that somebody got there first, not that they have finished writing — and the reader took the file as it found it. **Two entry points, and the first fix only covered one**: the `EEXIST` branch, and the ordinary read at the top of `loadLedgerKey`, whose comment carried the assumption that disproved it — _"the only way to produce one is a crash between creating and writing"_, when a concurrent writer produces exactly that state with no crash. **The test written for it caught the incomplete fix.** **Severity, stated precisely: this fails closed and never weakened the key.** `decodeStoredKey` validates the decoded length, so a truncated read is refused rather than accepted as a shorter key — tamper-evidence is intact and this is availability. The cost was real all the same: the refusal surfaced as a failed ledger write, which the gate turns into a blocked tool call, so an agent stopped and the operator was told the key was corrupt when it was merely young. Fixed by looking again before refusing, bounded at half a second, with the single-winner property untouched. **One of the three tests is the guard**; the concurrent-callers case passes against the unfixed code too and says so in its own comment, so the file is not read as three guards where there is one                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **278**           | §"2026-09-07"                                                    | **The installer builds the Control UI twice, and `--skip-ui` skips neither of them.** Found by reading a real install log rather than the script: two complete vite builds, producing **different content hashes for the same modules** (`index-BsUUeB2-.js` then `index-C3gUE8dF.js`), so both generations sit in `dist/`. `ui:build` is a phase of the `full` profile in `scripts/build-all.mjs`, and `scripts/vps-install.sh` ran `$PNPM build` and then `$PNPM ui:build` again. `index.html` points at the newer set so nothing breaks; the older set is dead weight, and it is **the same "two builds coexisting" state that broke `exec` (finding 274)**, arriving from the installer rather than from a crash. **The worse half is the flag**: `--skip-ui` skipped only the duplicate, so the UI was built regardless while the operator was told _"the governance dashboard will not be served"_ — a flag reporting a consequence it does not have, which is finding 113's class. There is no build profile that omits the UI, so the flag cannot do what its name promises; it is kept for scripts that pass it and now says what is true. **The same mistake was in `HANDOFF.md`'s rebuild command**, written the night before and corrected with it. Also corrected there: the command now starts with `git pull`, because the 2026-09-07 rebuild ran cleanly and reported `(d6a0121)` — the _previous_ commit — since the pull came afterwards. And the OOM warning is now marked a precaution rather than an observation: that build completed in 42 seconds with caches restored                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **296–304**       | `mg/SESSION-LOG-2026-09.md` §"2026-09-08" and §"2026-09-08 (ii)" | **The dashboard driven section by section, and from all four tiers.** Nine, all closed, and the tier sweep is what makes it different from every earlier dashboard pass — 239, 240, 241–252 and 264–268 were all done as **Root**, which is the tier every string gets written for. **296 is the one to read**: a reserved actor name (`cli`) was accepted as a username, which **bricked the installation** — bootstrapping Root as `cli` left every administrative action refused, Root undeletable and bootstrap closed, recoverable only by deleting `users.json` by hand — and the failure was not clean: creating an Administrator returned **400, created the account anyway, and wrote no ledger entry for it**. An administrative action that happened, was reported as failed, and is absent from the audit trail. Fixed at `createUser`, folded before comparing so `CLI` cannot slip past. **297** closed **T61** (a wrong password reported as an expired session) at the API layer, the option that row recommended. **298**: signing out reported itself as an expiry, then as a partial failure, and the abandoned refresh batch repopulated the previous account's state behind the sign-in screen — finding 271 by a different road. **299**: the role-change confirmation named the wrong Administrator, and named one at all when promoting to Administrator, because the dialog and the request derived the manager separately. **301**: `canAuthorPolicy` was never sent to the browser, so every **withheld** User read as allowed and was offered the authoring controls — five enabled Remove buttons on policy rules; the routes refused all of it, so it is finding 100's class, and it defeats T27's point. **302**: an agent's owner rendered as a raw account id to every tier below Root, because the id is resolved against the Root-only account list — finding 264 again, landing on the Administrator. **303**: three sentences written for whichever tier was in front of them, including _"You manage every agent"_ shown to a User with nothing assigned. **300** and **304** are the two clarity passes: what a tier may do, who answers to whom, a permission whose state was invisible, and a tier hint that described three tiers out of four                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **324, 325**      | `mg/SESSION-LOG-2026-09.md` §"2026-09-08 (vi)"                   | **Found while taking T55 with Mohammad, and both from writing the decision down before building it.** **324**: the policy document keys **five** things by agent id and the 2026-09-05 sweep had measured three — the per-agent **escalation override** (whether that agent pauses to ask a human) and the **timeout** waiting on it were never tested, and they inherit a reused id identically. A decision about what a name carries was about to be taken on three-fifths of what a name carries; measured before deciding rather than after (`docs-notes/qa-sweep-2026-09-08/t55-remaining-fields.ts`). The escalation override inherits in **either** direction: `off` refuses a replacement where it should pause and ask, `on-miss` lets it interrupt a human for anything no rule covers. **325**: `deprovisionAgent` computes `auditError` — the reason the ledger would not record an **irreversible deletion** — and its own doc comment ends _"The failure is not swallowed: it travels back and the surfaces say it."_ It travelled to the route, which **dropped it**, and the dashboard discarded the whole response anyway. So a deletion missing from a tamper-evident trail announced itself as plain success, and with the command line gone this is the only surface there is to say it — finding 195's shape, on the field written to prevent it. Both reasons now reach the operator as a warning they must dismiss                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **323**           | `mg/SESSION-LOG-2026-09.md` §"2026-09-08 (v)"                    | **The lint gate was recorded as 0 and was 4.** `oxlint` over `src ui/src` — the fifth verification command — reports `max-lines` on `api.ts` (708) and `governance-page.ts` (703), `no-inferrable-types` on T61's `authenticating` field, and `no-map-spread` on **finding 302's own fix**. `git stash` and re-run: **HEAD lints clean, exit 0**, so all four entered with the last day's work while the state table kept a number written the day before them — finding **227**'s mechanism on the row that certifies the gates. All four fixed rather than excepted; `governance-page.ts` by scoping the in-flight refresh guard to the _timer_ rather than wrapping `refreshData`, which is also the better fix because a refresh following a mutation is asked for and must never be skipped. **One lesson with 321**: the two verification commands skipped were the two that read the **artefact** and the **whole tree** rather than the file being edited, and they were the two that were red                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **321**           | `mg/SESSION-LOG-2026-09.md` §"2026-09-08 (v)"                    | **The tree did not build, and had not since the previous session.** `node scripts/build-all.mjs` fails at `ui:build`: _"startup JS gzip: 317.6 KiB exceeds 317.0 KiB"_. Measured by stashing and rebuilding rather than reasoned about — **HEAD 324522 B (passes, 86 B of headroom); + findings 296–304: 325138 B, over by 530 B; + this pass: 325241 B, over by 633 B.** So the regression entered with the dashboard clarity work and nobody ran the build. **Every source-level check stayed green throughout**: three typechecks, both lint gates, 2,761 tests, four standing probes, the standalone verifier. **Finding 284 from the other side** — that was deleted source still live in the artefact, this is source that passes everything and an artefact that will not build; §4 carries the build command under "After removing anything, check the build, not just the source", and it turns out not to be about removals. It would have failed on the VPS, which is §6's "Do this before anything else". **The mechanism is worth more than the fix**: `en.ts` is one locale module loaded at startup while the governance page is lazy, so every operator-facing sentence is multiplied across the locale set and charged to startup — and three days of this sweep have been, by instruction, about writing more and clearer sentences (300, 303, 304, 311, 320 are all text). Fixed by raising the fixed ceiling 317 → 318 KiB with the reasoning written into the constant, which is the "intentional decision" its own comment asks for; **the real answer is T64**, not a bigger budget                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| **319, 320, 322** | `mg/SESSION-LOG-2026-09.md` §"2026-09-08 (v)"                    | **Active agent sessions, driven.** All closed, neither an access defect. **319 is the one to read**: **a prompt started from the dashboard does not appear in the panel whose job is watching what is running.** Measured — a governance run reported by `agent/runs` for twenty consecutive polls while `sessions` answered `{"supported":true,"sessions":[]}` every time, under the words _"No agent sessions are running"_. `listActiveSessions` reads only `ops.chatAbortControllers`, which the Gateway's own admission path writes; `runGovernancePrompt` calls `agentCommandFromIngress` directly and never registers there. So the Administrator's half of **design requirement #2** was blank for the one way this product starts an agent — and the only way the **User** tier can start one at all — and since Stop and the Monitor toggle are per-row, no row means the only remaining control is the emergency lockdown, which `cancelPrompt`'s own comment argues must not become the ordinary way out. **No test asked because every test in `active-sessions.test.ts` stubs the supplier**: they measure the two scope filters correctly and cannot see that the supplier is missing half the runs. Fixed by merging the governance prompt-run table in as a second source **before** the group and `canViewAgent` filters, so the scoping stays in one place (finding 139 was one of those filters missing on one path); not fixed at the run path, because that would put governance into Gateway internals its own header forbids. **320**: the panel's unavailable state still read _"it is not available from **the CLI**"_ — a surface deleted 2026-09-07 — having survived the nineteen-document rewrite, the eleven-finding audit written for exactly that question (285–295), and the standing removal probe, because **all three searched for the command's spelling** and this sentence names the surface in prose. Finding 285's class with the search that found 285 blind to it; the probe's check is now widened to prose and scoped to the `governance:` block of `en.ts`, and was watched failing against the old string. **322**: the row put the agent id and an unlabelled forty-character run id side by side and left _who started this_ — the fact this panel is read for — decodable only by eye out of `agent:scout:governance:kinan`. The account is now shown where the key names one and omitted where it does not, because a guessed name on the panel you read to decide who to ask is worse than none                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **317, 318**      | `mg/SESSION-LOG-2026-09.md` §"2026-09-08 (iv)"                   | **The last day's work re-swept after the first pass was found to have covered a third of it.** Both closed. **317**: `scripts/vps-install.sh` says _"Idempotent: safe to re-run after a `git pull`"_ on line 18 and contains **no `rm -rf` at all** — so a re-run builds over the previous `dist/`, which is findings **274** and **284**'s exact state. `mg/HANDOFF.md` carries `rm -rf dist dist-runtime && pnpm build` in three places as the correct rebuild and `old-docs/removed-cli-surface/README.md` in a fourth; the script that does the same job, and is the one an operator is told they may re-run, had none of it. **Finding 278 was fixed in this very file on 2026-09-07**, the day 274 and 284 were written up, and the `rm -rf` did not travel with it. **318**: `composition-sweep.ts` exited **1** with `8/10` every time and always would — its two failures are T55 and T60, open **by decision** — with nothing distinguishing them from a regression. A probe that is permanently red is a probe nobody reads, which is findings 224/250/280's lesson turned on this project's own QA artefact. They now print as **OPEN**, name the row that owns them, and no longer set the exit code; a negated ordinary check was run to confirm the probe still exits 1 on a real regression. **Also re-run in this pass and green**: the standalone verifier (exit 0, 41 entries, checkpoint agrees, cross-checked against the dashboard's own verdict), `cli-removal-sweep` 9/9, `policy-semantics-sweep` 7/7, `systems-sweep` 17/17, and the suite at 2,761/21 across 145 files                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| **305–316**       | `mg/SESSION-LOG-2026-09.md` §"2026-09-08 (iii)"                  | **Your agents, driven from all four tiers.** Twelve; **eleven closed, 316 open as a decision (T63)**. Eight are invisible from Root. **305 is the one to read, and it is not about this section**: the dashboard **never re-read who the signed-in account is**. `refreshIdentity()` had exactly one caller, `connectedCallback`, and signing in assigned `identity` directly — so for the life of a session the browser's copy of an account's tier, assigned agents and authoring permission was whatever it had been at the first paint, while ten panels reloaded around it every fifteen seconds. Measured with a User signed in throughout: an agent **revoked** stayed on screen with a live composer for 45s and answered `You do not manage agent "scout"` when used; an agent **granted** never appeared; and authoring **withheld** left six enabled Remove buttons on policy rules while `whoami` was already answering `canAuthorPolicy: false`. **That makes finding 301 half-delivered** — 301 taught the routes to send the field and was verified by signing in _as_ a withheld User, the one path that already worked. **306**: Root and every Administrator could open a conversation and had nothing to close it with, and the control that looks like the way back — the "Choose an agent…" placeholder — is dropped by `if (chosen)`, so the select reset itself and left the transcript standing beneath it. **307**: the conversation rendered after the whole list, headed with the agent id a second time, on a row that already set `stacked` for it and had never been given anything. **308**: the message just sent appeared nowhere until the run ended — "No messages yet. Send the first one below." rendered directly above a live "replying…" block, while the host's own chat on the same page shows it at once. **309**: the assigned rows named an agent by id while the page held its name, so the User tier read the least informative label on the page. **310**: a typed `SCOUT` opened `scout` and the heading kept the typed case (finding 128's class). **311**: a User with nothing assigned was handed an id box that could only be refused — the exact inverse of what finding **303** had corrected in the sentence beside it one day earlier. **312**: the conversation panel sizes to its own content, so the message box was **155px at every window width** (measured unchanged from 1280 to 1900; the host's chat box is 648px) — and **313** is why nothing saw it: the layout test's fixture set no conversation and no agents, so the composer and the picker had never been in front of a layout engine. **Finding 251 exactly, one panel over.** **314**: the auto-refresh has no in-flight guard, and request durations climbed 0.26s → 5.3s → 10.2s → **44.3s** on routes `curl` answered in 0.25s. **315**: the picker and the id box shared one accessible name. **The guard for 312 was withdrawn rather than shipped** — three drafts of a width assertion passed against every candidate revert, because the browser harness mounts a bare 1100px block and does not build the settings pane the live geometry comes from; finding 224's rule applied to my own test                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **285–295**       | `mg/SESSION-LOG-2026-09.md` §"2026-09-07 (iv)"                   | **The removal audited from the outside: what still names the deleted surface to a person.** Eleven, all closed, and **not one is an access-control defect. 285 is the one to read**: the dashboard's chain-verification row — finding 268's own fix, the repair whose claim is _"the dashboard is no longer the only witness"_ — told the operator to run `openclaw governance audit verify`, deleted the day before. It survived the nineteen-document rewrite because it is a **string literal in `.ts`**, is **not an identifier** so no gate has an opinion about it, and `en.ts` holds the sentence while the panel interpolates the command, so even searching the translation file finds the sentence without the command in it. Now `node scripts/verify-ledger.mjs`, pinned in both directions. **286 and 287 audit that replacement**, driven rather than read, and both are false alarms rather than false passes — the failure its own header calls worse than having no verifier: it printed `checkpoint: #2 AHEAD of the ledger` on a three-entry chain where the checkpoint was **behind** (the legitimate state a crash between the append and the checkpoint write leaves), directly under the word INTACT; and it accepted a signing key below `MIN_SUPPLIED_KEY_LENGTH`, which the product refuses outright, HMACed every entry under one byte and reported **BROKEN, exit 1** instead of exit 2. **288** struck a live core rule through as removed, making `BASELINE-RULES.md` describe **seven** core rules and **two** self-protecting ones where the product has **eight and three** — the `5 + 3` split T24 rests on; driven at the gate to confirm all three spellings are still refused. **289**: `LINUX-INSTALL.md` §6 kept _"`governance deployment` … runs over a plain SSH session, before any tunnel exists"_ in the present tense two lines under the note saying it no longer exists. **290**: `describeShedPendingDecisions`, written that evening to stop one sentence existing twice, had no production caller and had already become the second copy — deleted, and its two tests with it, both of which measured a string nothing displayed. **291**: `README.md` claimed the command line one paragraph above saying it was removed. **292**: `endSession`'s listing comment said 50 declared / 48 cleared; it is 51 / 49, T56 having added a field hours later — the behaviour right, the measurement beside it stale. **293**: three self-references stale in files edited the same day, including `verify-ledger.mjs` citing a test file that has never existed while resting its central independence claim on it. **294**: `HANDOFF.md` said 284 / 281 / 3 and `PROJECT-SUMMARY.md` said 277 / 275 / 2 **on the same day**, both as the project's headline defect number, after a commit reading "every register brought level for handoff" — and the second did not agree with its own breakdown either. **295**: `old-docs/removed-cli-surface/README.md` §4b still told whoever restores or removes the surface to run `rm -rf dist dist-runtime && pnpm build` — the exact command that deleted the build and then exited 127 on 2026-09-07, whose lesson was written into the session log and not into the file carrying the command                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **284**           | §"2026-09-07 (iii)"                                              | **The removed command line was still fully present in the build.** Found on a second, adversarial pass over the removal, after the first pass had reported it complete. Every source file was gone, both registries were clean, the `--help` descriptor had been removed (283), three typechecks and both lint gates were green, and the dedicated removal sweep passed 7/7 — and `dist/` still contained **`register.governance-BfFo31MS.js`**, the whole compiled command tree, plus the descriptor string inside `dist/argv-*.js`. So on any machine running the shipped artefact, including the VPS, **`openclaw governance …` still worked**. Source and artefact had diverged and nothing in the project compared them. **Two things make this worse than a stale build.** First, `dist/` is three days old and predates the removal, so the divergence is invisible to anyone who does not check timestamps. Second, and this is finding **274**'s exact mechanism: **nothing in the build ever clears `dist/`**, so a plain `pnpm build` would have left `register.governance-*.js` orphaned there indefinitely — a compiled command tree with no source, which is a worse state than either end. Only `rm -rf dist && pnpm build` removes it, which is why the handoff's rebuild command carries that `rm -rf` and why it is the first instruction in §6. **The general lesson, and it is the one to carry into the report: deleting source does not delete the product.** Every check this project runs — typecheck, lint, suite, and the removal sweep written for this very change — reads the _source tree_. The thing a user runs is the _build_, and nothing was comparing the two                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| **283**           | §"2026-09-07 (iii)"                                              | **A removed command was still advertised.** Found by `cli-removal-sweep.ts` on its first run, after the governance command line was deleted. All eight source files were gone, the command-registry entry was gone, three typechecks and both lint gates were clean — and `core-command-descriptors.ts` still declared a `governance` descriptor, which drives `--help`, argv routing and command suggestions. So `openclaw --help` would have listed a command group that could not load, and `openclaw governance …` would have been routed as a known command before failing. **Finding 100's class arriving through a deletion**: an interface describing a capability it does not offer. Worth recording as its own finding because nothing else could have caught it — the suite passes by construction after a removal, since deleting a surface deletes its tests, and the typechecks were clean because a descriptor is data rather than an import. **The general lesson: deleting the implementation of a thing does not delete the places that announce it**, and the announcement is what a user meets first                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **279–282**       | §"2026-09-07 (ii)"                                               | **The composition axis: three days of features driven against each other rather than one at a time.** Every feature landed 2026-09-05/07 has tests, and each drives it _alone in a governance directory made one line earlier_. **279 (security-relevant, fixed):** `proposeRuleFromEscalation` lists three properties it guarantees and the third — "it carries the access half for paths; a read that was escalated proposes a read, not a read and a write" — **was false**. `RuleRequest` had no `access` field, so the direction reached the reviewer only inside the `reason` prose and never reached the rule; an absent `access` on a `PolicyRule` means **both directions**. Measured at the gate, not inferred: escalate a read, answer Allow always, approve it through the real route, and a **write** to the same path came back allowed — while the queue row said "(read)", because `describeRequest` prints the reason. Of the three claimed properties, the two with tests behind them held and the one without did not. Fixed by carrying `access` on the request, through both approval surfaces, into `describeRequest`, and into the de-duplication (without which a read proposal would swallow a later write proposal — the same defect arriving through the dedupe). **280 (fixed):** finding 271's fix cleared the transcript; listing the page's 50 `@state()` fields against the 15 `endSession` cleared showed **twenty-three survived a sign-out**, of which `refreshData` reloads only three. The Agent permissions panel stayed open on the previous account's agent showing its rules and **the usernames assigned to it**, a stale `role="alert"` announced an emergency stop the next person did not order, and the authoring and request forms came back filled in with the previous account's half-typed rule and the agent and account it named. Now 48 of 50, with the two exceptions named and argued. **The first repair covered three of the twenty-three and was itself the same mistake one layer down** — caught by re-running the listing after fixing, not by noticing. **281 (open, T60):** every escalation proposal is filed under one labelled origin and the pending cap counts per requester, so all of them share a single 20-slot budget for the whole organisation; 25 distinct escalations answered Allow always produced **20** proposals, and the five grants that proposed nothing are recorded only in the ledger. The button still reads "Always allow". **282 (fixed):** the documentation pass — nine stale claims in seven files from the `allow-always` restoration alone, plus the intent field's "never wrong" safety claim in three live documents, six stale T2/T3 claims including the register saying _"no language model has driven a tool call through this layer"_, and this file's own header. **A second pass while compiling the remaining-work inventory found nine more**, every one of them a claim that something was still open after it had closed: this file's "Current as of 2026-09-03: 37 done, 9 open" (four days and twelve state changes stale) and its "**Everything still open is Kinan's** … Nothing is waiting on Claude" (six of the fifteen open items are Kinan-then-Claude); "the dashboard does not surface [the intent]", which it has done for some time; T29's register-coverage half called "still open" in **three** places after closing on 2026-08-28, including `GOVERNANCE.md` and `CHAPTER3-MATERIAL.md`; the handoff's "Nothing to do" section saying T7's prevention half was open eight days after it closed; and decisions **B** and **C** in §"Three decisions that are not M5 or M6" left unstruck for eight and twelve days after both were taken. **The pattern across all eighteen is one direction**: a thing closes, the row that owns it is struck, and every _sentence_ about it elsewhere keeps the old state. Nothing was ever stale in the other direction |

**The two that are open, and neither is unfixed by accident:**

- **169**, an unexplained observation. It stays open because a `| tail` discarded
  the name of a failing test and three later runs did not reproduce it. It is the
  standing argument for never piping a suite through a summary filter.
- **258**, a decision rather than a repair: a reused agent id inherits the
  previous agent's rules, posture and lockdown. `unregisterAgent` documents that
  survival as deliberate for _unregistration_, and re-registration under a reused
  id is not covered by that reasoning, so it is **T55** and Kinan's.

**The standing rule this section exists to protect.** Several documents describe
findings as being "written up in all three registers". That has not been true
since 2026-08-27, and every register should say where it stops rather than let a
reader assume it is complete. `GOVERNANCE.md` carries the same admission, with
the count derived by subtraction rather than edited in place.
