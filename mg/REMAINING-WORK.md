...
below, **fifty-nine tasks, T1–T59, of which 44 are struck and 15 open** (T1 is
...
**Current as of 2026-09-03: 37 done, 9 open; T1 and T41 are not being done** across
T1–T48. **37 + 9 + 2 = 48**, and the arithmetic is written out because without it
this line was wrong again within the hour. The four new ones (T45–T48) came from
the VPS deployment of 2026-09-03 and from Kinan directly.
...
## Where this file's findings stop, and where 241–278 are (recorded 2026-09-05, extended 2026-09-06)

**This file's finding write-ups end at 240.** Findings **241–278** are not in it,
